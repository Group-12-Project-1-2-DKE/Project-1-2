...
public class MazeOption implements Screen {
    ...
    private final int BACK_WIDTH = 125;
    private final int BACK_HEIGHT = 125;
    private final int PLAY_Y = 75;

    // The textfields on which the user will enter its values.
    private TextField mazeX;
    private TextField mazeY;
    ...
    public MazeOption(ScreenSpace game) {
        ...
        mazeX = new TextField(String.valueOf(10), customizedMenuSkin);
        mazeX.setPosition(25,675);
        mazeX.setSize(200, 30);
        mazeX.setColor(Color.WHITE);
        stage.addActor(mazeX);

        mazeY = new TextField(String.valueOf(10), customizedMenuSkin);
