...
import com.mygdx.game.TerrainChunk;
...
public class GolfGameMaze implements Screen {
    ...
    public GolfGameMaze(ScreenSpace game) {
        ...
        Ball gameBall = new Ball(new Vector2D(0, 0), 4, 5); //i entered some random values

        course = new PuttingCourse("1", new Vector2D(0, 0), new Vector2D(10, 10), gameBall, 0.1, 7, 1.0);
